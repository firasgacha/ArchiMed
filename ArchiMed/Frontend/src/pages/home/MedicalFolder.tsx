        ...
        <>
                ...
                <div className="sm:px-6 w-full">
                    <div className="px-4 md:px-10 py-4 md:py-7">
                        <div className="flex items-center justify-between">
                            <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">My Appointments</p>
                    ...
                    <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                        <div className="sm:flex items-center justify-between">
                            ...
                            {/* <button className="mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded">
                                <p className="text-sm font-medium leading-none text-white">Pick an appointment</p>
                            </button> */}
                        </div>
            ...
            <div className="flex justify-around">
                <div className="min-w-[250px] max-w-[350px]">
                    <Card name={"My Medications"} image={"https://firstaidforlife.org.uk/wp-content/uploads/2018/03/poisoning-pill-bottle.jpg"} />
                </div>
                <div className="min-w-[250px] max-w-[350px]">
                    <Card name={"My Scanners"} image={"https://file1.topsante.com/var/topsante/storage/images/1/3/1/2/1312120/comment-deroule-examen-scanner.jpg?alias=exact540x405_l&size=x100&format=jpeg"} />
                </div>
                <div className="min-w-[250px] max-w-[350px]">
                    <Card name={"My Radios"} image={"https://s3-us-west-2.amazonaws.com/utsw-patientcare-web-production/original_images/radiology-600x338.jpg"} />
                </div>
            </div>
            {/* cards */}
