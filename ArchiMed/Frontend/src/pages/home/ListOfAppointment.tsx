...
export default function ListOfAppointment() {
  ...
  const deleteAppointment = async () => {
    selectedFlatRows.map(async (row) => {
      await axios.delete(`Appointment/${row.original.appointmentId}`)
        .then((res) => {
          fetchData();
        }).catch((err) => {
          console.log(err);
            ...
            <div className="flex items-center justify-center h-full w-full">
              <div className="bg-white rounded-md shadow fixed overflow-y-auto sm:h-auto w-10/12 md:w-8/12 lg:w-1/2 2xl:w-2/5">
                ...
                <div className="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
                  <form className="mt-2">
                    <div className="flex items-center justify-center space-x-9 mt-8">
                      <input onChange={(e) => setappointmentDate(e.target.value)} placeholder="Birthday" type="date" className="w-1/2 text-center focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200" />
                    </div>
                    <div className="flex items-center justify-center space-x-9 mt-8">
                  ...
                  <div className="flex items-center justify-between mt-9">
                    <button onClick={() => setshowAddAppointment(!showAddAppointment)} className="px-6 py-3 bg-gray-400 hover:bg-gray-500 shadow rounded text-sm text-white">
                      Cancel
                    </button>
                    <button onClick={() => addAppointment()} className="px-6 py-3 bg-indigo-700 hover:bg-opacity-80 shadow rounded text-sm text-white">Confirm</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center h-full w-full">
              <div className="bg-white rounded-md shadow fixed overflow-y-auto sm:h-auto w-10/12 md:w-8/12 lg:w-1/2 2xl:w-2/5">
                <div className="bg-gray-100 rounded-tl-md rounded-tr-md px-4 md:px-8 md:py-4 py-7 flex items-center justify-between">
                  ...
                  <button className="focus:outline-none">
                    <svg onClick={() => setshowEditAppointment(!showEditAppointment)} width={20} height={20} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M21 7L7 21" stroke="#A1A1AA" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M7 7L21 21" stroke="#A1A1AA" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                ...
                <div className="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
                  <form className="mt-2">
                    <div className="flex items-center justify-center space-x-9 mt-8">
                      <input defaultValue={appointmentDate} onChange={(e) => setappointmentDate(e.target.value)} placeholder="Birthday" type="date" className="w-1/2 text-center focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200" />
                    </div>
                    <div className="flex items-center justify-center space-x-9 mt-8">
                  ...
                  <div className="flex items-center justify-between mt-9">
                    <button onClick={() => setshowEditAppointment(!showEditAppointment)} className="px-6 py-3 bg-gray-400 hover:bg-gray-500 shadow rounded text-sm text-white">
                      Cancel
                    </button>
                    <button onClick={() => editAppointment()} className="px-6 py-3 bg-indigo-700 hover:bg-opacity-80 shadow rounded text-sm text-white">Confirm</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto bg-white rounded">
            <div className="flex justify-between border-b border-gray-300 py-5 bg-white">
              <div className="flex mx-auto xl:w-full xl:mx-0 items-center">
                ...
                <svg onClick={() => setshowAddAppointment(!showAddAppointment)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <svg onClick={() => deleteAppointment()} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-3">
